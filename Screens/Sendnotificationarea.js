...
export default class Sendnotificationarea extends React.Component {
...
allUserValue: "",
UserValue:"" ,
AreaValue: this.props.navigation.getParam('areaid'),
flagUser:false,
flagArea: false,
flagAll:false,
title: "",
...
<Card style={{borderRadius: 10, backgroundColor: 'blue'}}>
        <Text style={{margin: 5, fontSize: 20}}>Notification All your Employees</Text>
    ...
    />
      ...
      {/* <View>
        <Text style={{marginTop: 8, marginLeft: 5, justifyContent: "flex-start"}}> Area ID </Text> 
      <Input 
            multiline= {true}
            
             placeholder={this.state.AreaValue}
