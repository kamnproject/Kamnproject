 ...
 componentDidMount() {
  ...
  db.collection("Trashcan_Issues")
    ...
    { 
      ...
      db.collection("Trashcan_Issues").where("Status", "==", "active")
      .onSnapshot(querySnapshot => {
        let f = []
        querySnapshot.forEach(doc => {
    ...
    {  
      this.temp == "admin@admin.com" ?
       ...
       <View  style={{ flexDirection: "row"  ,justifyContent: "space-between"}}>
        <Text style={{fontWeight: "bold", marginLeft: 5, marginTop: 5, marginBottom: 8}}> Trashcan Issues</Text>
      ...
      <Button 
        ...
        <ScrollView>
          ...
          <View  >
          <Text style={{fontWeight: "bold", marginLeft: 5, marginTop: 5, marginBottom: 8}}> Trashcan Issues Active</Text>
